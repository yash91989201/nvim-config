return {
	...
	config = function()
		...
		-- set keymaps
		keymap.set("n", "<leader>xv", "<cmd>ToggleTerm direction=vertical size=64<CR>", { desc = "Toggle vertical terminal" })
		keymap.set("n", "<leader>xh", "<cmd>ToggleTerm direction=horizontal size=24<CR>",
